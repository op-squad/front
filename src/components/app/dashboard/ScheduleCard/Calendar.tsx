...
function Day({ index, currentDay, setCurrentDay }) {
  ...
  if (index == 1) {
    style = `flex justify-center items-center before:content-[''] before:size-8 2xl:before:size-10 before:rounded-full relative before:absolute before:-z-10 z-0 cursor-pointer col-start-${startOfMonth.toString()}`;
  }
